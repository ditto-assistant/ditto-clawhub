...
- [x] `@heyditto/cli` published on npm (1.1.1, [trusted publisher](https://docs.npmjs.com/trusted-publishers) via [`ditto-cli`](https://github.com/ditto-assistant/ditto-cli) GH Actions)
...
Most OpenClaw users won't need this — they get `ditto` via `npm install -g @heyditto/cli`. The standalone binaries are for users who don't want Node, or for direct GitHub Releases.
