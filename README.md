...
The `publish/` folder. Three text files, about 420 lines total:
...
| `publish/examples.md` | Agent patterns: recall, opinion-search, save, network-traversal, TweetClaw research capture, first-run-no-key. |
